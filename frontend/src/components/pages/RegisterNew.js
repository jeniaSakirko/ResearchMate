...
export const RegisterNew = () => {
    ...
    const dialogFooter1 = <div className="flex justify-content-center"><Button label="OK" className="p-button-text" autoFocus onClick={() => setShowMessage1(false) } /></div>;
    ...
    return (
        <div className="form-demo">
            ...
            <Dialog visible={showMessage1} onHide={() => setShowMessage1(false)} position="top" footer={dialogFooter1} showHeader={false} breakpoints={{ '960px': '80vw' }} style={{ width: '30vw' }}>
                <div className="flex align-items-center flex-column pt-6 px-3">
            ...
            <div className="flex justify-content-center">
                <div className="card">
                    ...
                    <Form onSubmit={onSubmit} initialValues={{ username: '', email: '', password: '', firstName: null, lastName: null,phone:null, accept: false }} validate={validate} render={({ handleSubmit }) => (
